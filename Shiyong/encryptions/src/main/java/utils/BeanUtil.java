...
import srp.bapp.pub.runtime.BappMetaDataDefineException;
...
public class BeanUtil extends BeanUtils {
	...
	public static Object getServiceBean(String id) {
		Object serviceBean = JdbcSupportDAO.getServiceBean(id);
		if(serviceBean==null){
			logger.error("找不到beanId:" +id+".",new BappMetaDataDefineException("beanId not found."));
		}
		return serviceBean;
	}
